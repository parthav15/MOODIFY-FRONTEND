...
import { Menu, X, ArrowRightCircle, Music } from "lucide-react";
...
const Navbar = () => {
    ...
    const navItems = [
        { name: "Home", path: "/" },
        { name: "Music Recommendation", path: "/recommendation" },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link to="/" className="flex-shrink-0">
                        <motion.span
                            className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent flex items-center"
